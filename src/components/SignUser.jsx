    ...
    <div >
       ...
       <div className='w-full h-full relative'>
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black via-black/30 to-black flex justify-center items-center  ">
         <div className='z-100  absolute m-auto w-10/12 md:6/12 lg:w-5/12 h-auto p-6  border-black rounded-lg  py-8  bg-black/70 text-white'>
          <form action="" className='flex flex-col gap-2 ' onSubmit={(e)=> e.preventDefault()}>
            ...
            <p className=' text-md text-center mt-3 text-blue-600 cursor-pointer' onClick={handlePage}>{isSignIn ? "do not have any account? create now": "already have an account ? sign in"}</p>
          </form>
        </div></div>
